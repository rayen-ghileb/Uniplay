...
class TimeSlot(models.Model):
	terrain = models.ForeignKey(Terrain, on_delete=models.CASCADE, related_name="timeslots")
...
class Reservation(models.Model):
	...
	timeslot = models.ForeignKey(TimeSlot, on_delete=models.PROTECT, related_name="reservations")
	...
	class Meta:
		constraints = [
			models.UniqueConstraint(fields=["timeslot"], name="unique_reservation_per_timeslot")
		]
		ordering = ["-created_at"]
